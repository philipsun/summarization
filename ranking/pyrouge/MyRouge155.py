...
##                    system_re.pattern, system_dir))
        ...
        with codecs.open(config_file_path, 'w', encoding='utf-8') as f:
            ...
            f.write("</ROUGE-EVAL>")
def TestMyRouge():
    system_dir = r'E:\pythonworknew\code\paperparse\paper\papers\acl_exc_withoutstop_max100'
    model_dir = r'E:\pythonworknew\code\paperparse\paper\papers\model_html'
    system_idset = ['01','02','03','04','05','06','07']
    model_filename_pattern =  r'P14-#ID#.xhtml.[A-Z].html'
    system_filename_pattern = r'^P14-(\d+).xhtml.html'
    config_file_path  = r'E:\pythonworknew\code\paperparse\paper\rouge_conf.xml'
    perlpathname=r'D:\Perl\bin\perl'
...
def TestRe():
    ...
    syspattern =system_filename_pattern + '.' +eachdir + '$'
    system_re = re.compile(syspattern)
    system_filename = r'P14-1007.xhtml.html.01'
    match = system_re.match(system_filename)
