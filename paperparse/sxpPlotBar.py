...
##        autolabel(eachr)
def PlotBarFromCoordSet(titlename, coordset,coordname,colorset = default_color,fname='output.jpg',highratio=0.2, symax = 1.0, widthratio = 1.0,xshift=1.0,xfontdict = {},xtickrotation=0):
    N = len(coordname)
